...
export const otherRouter = {
    ...
    children: [
        ...
        { path: 'userInfo/:id', title: '人员详情',icon: 'person', name: 'userInfo', component: resolve => { require(['@/views/user/info.vue'], resolve); } },
...
export const appRouter = [
    ...
    // },
    {
        ...
        component: Main,
        children: [
            {path: 'search', title: '信息查询',icon: 'search',name: 'user_search', component: resolve => { require(['@/views/user/search.vue'], resolve); } },
            {path: 'add', title: '添加人员',icon: 'person-add',name: 'user_add', component: resolve => { require(['@/views/user/add.vue'], resolve); } },
        ]
    },
    {
        path: '/authority',
        ...
        access: -1,
        children: [
            { path: 'index', title: '管理员管理', name: 'authority_index', component: resolve => { require(['@/views/authority/authority.vue'], resolve); } }
        ]
    },
    // {
    //     path: '/access-test',
